...
public class Parser {
    ...
    public static Operator getOperatorFromString(String s){
        switch (s){
            case "and": return new And(null,null);
            case "or" : return new Or(null,null);
            case "xor": return new Xor(null,null);
            case "imp": return new Imp(null,null);
            case "gdw": return new Gdw(null,null);
            case "not": return new Not(null);
            default: return null;
        }
    }
